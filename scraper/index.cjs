/**
 * Indian Parliamentary Constituencies Scraper
 * Source: Election Commission open data
...
async function scrape() {
  console.log('Indian Parliamentary Constituencies Scraper');
  console.log('Source:', 'Election Commission open data');
